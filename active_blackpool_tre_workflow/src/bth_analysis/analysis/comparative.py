...
def run_comparative(
    ...
    development_override = bool(cfg["comparative"].get("development_allow_unconfirmed_groups", False))

    if not (group_ready and index_ready) and not development_override:
        raise RuntimeError(
