    ...
    *,
    ...
    if start_raw in (None, "") or end_raw in (None, ""):
        add(
            ...
            "approved BTH/TRE extract coverage documentation; do not reuse the synthetic "
            "simulator window.",
        )
    else:
        try:
    ...
    summary_path = save_stage_summary(
        ...
        warnings=[
            "The real BTH study window must come from approved extract documentation, not the synthetic simulator dates.",
