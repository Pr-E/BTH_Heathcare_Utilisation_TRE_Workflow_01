...
Cluster inputs are restricted to baseline healthcare-utilisation rates. The code recomputes K=2..6 diagnostics, checks stability and size, and only retains the development-informed K=4 candidate if it remains defensible on real data.
