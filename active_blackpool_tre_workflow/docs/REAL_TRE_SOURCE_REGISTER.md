...
This register separates **genuine real-TRE source facts** from development/synthetic assumptions.
...
## Values deliberately NOT transferred from synthetic development

The following are not hard-coded as real-data facts:

- synthetic cohort counts;
- synthetic event rates;
- synthetic propensity overlap ranges/weights/SMDs;
- synthetic clustering centroids or K=4 membership;
- synthetic study coverage dates `2020-01-01` to `2026-07-31`;
- synthetic programme-start timing assumptions.

All of these must be regenerated or confirmed inside the TRE.
